...
namespace DefaultNamespace
{
	public class PositionSaver : MonoBehaviour
	{
        ...
        //MY должен применяться для хранения, сериализации и десериализации
        //информации о положении кубика в пространстве.
        ...
        [ReadOnly, SerializeField, Tooltip("to fill in this field, use the context menu in the inspector and the “Create File” command.")] 
		private TextAsset _json;

        [HideInInspector] public List<Data> Records { get; private set; }
